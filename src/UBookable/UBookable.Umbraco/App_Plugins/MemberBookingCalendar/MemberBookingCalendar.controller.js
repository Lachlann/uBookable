...
itembasedbookingApp.controller("UBookable.MemberBookingCalendar", function ($scope, $filter, $http, $routeParams, dialogService) {
    ...
    $scope.calendarOptions = {
        ...
        eventClick: function (data) {
            ...
            dialogService.open({
                template: '/App_Plugins/MemberBookingCalendar/templates/booking-list-view.html',
                show: true,
                dialogData: data,
